...
data_root = '/shared/niudt/DATASET/Medical'
data = dict(
    samples_per_gpu=64,
    workers_per_gpu=4,
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/7_3_challenging_vitpose_all_images/casualty_train.json',
    ...
    val=dict(
        type='TopDownCocoDataset',
        ann_file=f'{data_root}/7_3_challenging_vitpose_all_images/casualty_val.json',
        img_prefix=f'{data_root}/images/',
        data_cfg=data_cfg,
