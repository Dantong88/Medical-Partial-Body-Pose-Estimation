...
def user_parser(epilog=None):
    ...
    parser.add_argument("--config-file", default="/shared/niudt/detectron2_ori/detectron2/configs/LVISv1-InstanceSegmentation/medic_pose.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
