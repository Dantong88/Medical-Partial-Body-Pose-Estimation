...
# from .lvis_v1_categories_kitchen import LVIS_CATEGORIES as LVIS_V1_CATEGORIES
# from .lvis_v1_category_image_count_kitchen import LVIS_CATEGORY_IMAGE_COUNT as LVIS_V1_CATEGORY_IMAGE_COUNT
from .lvis_v1_categories_pose import LVIS_CATEGORIES as LVIS_V1_CATEGORIES
from .lvis_v1_categories_pose import LVIS_CATEGORIES as LVIS_V1_CATEGORY_IMAGE_COUNT
...
def register_lvis_instances(name, metadata, json_file, image_root):
    ...
    """
    image_root = '/shared/niudt/DATASET/Medical/Maydemo/2023-4-25/ALL/images'
    if 'train' in name:
        json_file = '/shared/niudt/DATASET/Medical/Maydemo/2023-4-25/split/user+env/coco_train_bbox_10012.json'
    elif 'val' in name:
        json_file = '/shared/niudt/DATASET/Medical/Maydemo/2023-4-25/split/user+env/coco_val_bbox_1896.json'
...
def _get_lvis_instances_meta_v1():
    # assert len(LVIS_V1_CATEGORIES) == 313
